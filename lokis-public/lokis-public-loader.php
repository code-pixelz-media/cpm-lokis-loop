...
function cpm_lokis_public_scripts()
{
    ...
    wp_localize_script('cpm-lokis-public-js', 'loki_ajax_obj', array(
        'nonce' => wp_create_nonce('loki_nonce_action')
    )
    );
}
...
if (!function_exists('loki_user_registration')) {
    function loki_user_registration()
    {
        ...
        // if (!wp_verify_nonce($_POST['nonce'], 'loki_nonce_action')) {
        //     $response = array(
        //         'status' => 'error',
        //         'message' => 'Registration error. Plesase contact us at lokisloop@uw.edu'
        //     );
        //     wp_send_json($response);
        //     return;
        // }

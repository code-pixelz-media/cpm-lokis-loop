            ...
            <div class="lokisloop-dashboard-container">
                ...
                <div class="lokisloop-hosted-game">
                    ...
                    <div class="lokisloop-container-wrapper">
                        <h5>
                            <?php esc_html(_e("Expired Games", "lokis-loop")); ?>
                        </h5>
                        <?php
                        ...
                        <table id="expired-games" class="lookisloop-games">
                            <div class="thead">
                                <tr>
                                    ...
                                    <th scope="col">
                                        <?php esc_html(_e("Started", "lokis-loop")); ?>
                                    </th>
                                    <th scope="col">
                                        <?php esc_html(_e("Expired", "lokis-loop")); ?>
                                    </th>
                                    <th scope="col">
                            ...
                            <tbody>
                                ...
                                $query = $wpdb->prepare("SELECT * FROM $lokis_game_sessions_table_name WHERE host_id = %d AND expires_in < NOW()", $host_id);
                                // Run the query
                                ...
                                if ($wpdb->num_rows > 0) {
                                    ...
                                    if (!empty($expired_games)) {
                                        ...
                                        echo "<tr><td colspan='6'>" . esc_html(__('No expired games found.', 'lokis-loop')) . "</td></tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='6'>" . esc_html(__('No expired games found.', 'lokis-loop')) . "</td></tr>";
                                }

        ...
        <div class="lokisloop-hosted-game">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($previously_inserted_sessions == 0) {
                    ...
                    echo '<div class="lokis-loop-correct" role="alert"><p class="lokis-loop-correct-title">Game Session created successfully </p>  <p> URL :  <a href="' . $game_url . '">' . $game_url . '</p></a></div>';

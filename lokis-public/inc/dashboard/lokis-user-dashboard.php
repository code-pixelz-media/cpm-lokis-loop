                                ...
                                <div class="lokis-gamehost-profileform-container">
                                    ...
                                    <div class="lokisloop-profile-form">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <script>                                         const generatePassword = () => { const passwordLength = 12; const characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()-_=+[{]}\\|;:'\",.<>/?"; const password = Array(passwordLength).fill(0).map((e, i) => characters.charAt(Math.floor(Math.random() * characters.length))); document.getElementById("loki-new-password").value = password.join(""); document.getElementById("loki-new-password-retype").value = document.getElementById("loki-new-password").value; };

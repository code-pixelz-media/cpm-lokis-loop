    ...
    <div class="lokisloop-completed-games-container">
        ...
        <table id="current-gamess" class="lookisloop-games">
            ...
            <tbody>
                ...
                $lokis_player_game_ids = $wpdb->get_results("SELECT id,session_id, step  FROM $lokis_player_table_name WHERE completed = '0' AND player_id = '$current_user_id' ");
                ...
                if ($current_page_games) {
                    foreach ($current_page_games as $game_id) {
                        ...
                        // die($game_expiration . '<br> time:' . date('Y-m-d H:i:s'));
                        ...
                        echo "<td  data-label='URL:'><a href=" . $game_url . " target='_blank'>' . $game_url . '</a></td>";
